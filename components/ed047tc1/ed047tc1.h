...
class ED047TC1Display : public display::DisplayBuffer {
 public:
  ...
  void set_pwr_pin(GPIOPin *pwr_pin) {
    pwr_pin_ = pwr_pin;
  }
  void set_bst_en_pin(GPIOPin *bst_en_pin) {
    bst_en_pin_ = bst_en_pin;
  }
  void set_xstl_pin(GPIOPin *xstl_pin) {
    xstl_pin_ = xstl_pin;
  }
  void set_pclk_pin(GPIOPin *pclk_pin) {
    pclk_pin_ = pclk_pin;
  }
  void set_xle_pin(GPIOPin *xle_pin) {
    xle_pin_ = xle_pin;
  }
  void set_spv_pin(GPIOPin *spv_pin) {
    spv_pin_ = spv_pin;
  }
  void set_ckv_pin(GPIOPin *ckv_pin) {
    ckv_pin_ = ckv_pin;
  }
