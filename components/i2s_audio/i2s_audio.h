...
class I2SAudioBase : public Parented<I2SAudioComponent> {
 public:
  ...
  void set_mclk_multiple(i2s_mclk_multiple_t mclk_multiple) {
    this->mclk_multiple_ = mclk_multiple;
  }
...
class I2SAudioComponent : public Component {
 public:
  ...
  i2s_port_t get_port() const {
    return static_cast<i2s_port_t>(this->port_);
  }
#endif
